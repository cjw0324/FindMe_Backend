...
public class GetPtLosfundInfoAccToClAreaPdController {
    ...
    public ResponseEntity<List<Item>> findWithDate(@RequestBody SearchItemsWithDate items, @RequestParam("pageNo") int pageNo) {
        try {
...
//                Object itemsObject = response.getResponse().getBody().getItems();
//                if (itemsObject instanceof List) {
//                    itemList.addAll((List<Item>) itemsObject);
//                } else if (itemsObject instanceof Item) {
