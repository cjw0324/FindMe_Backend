...
@RestController
public class GetPtLosfundInfoAccToLcController {
    @PostMapping("/api-find-with-location")
    public List<Item> FindWithLocation(@RequestBody SearchItemsWithLocation items, @RequestParam("pageNo") int pageNo) throws IOException {
        // API URL 생성
